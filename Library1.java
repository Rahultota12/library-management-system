...
class methods{
    ...
    methods(){
        availableBooks.add("Geeta");availableBooks.add("Ramayana");availableBooks.add("Gitanjali");availableBooks.add("Tamas");
        availableBooks.add("History");availableBooks.add("Constition");availableBooks.add("Godan");availableBooks.add("Madhusala");
        availableBooks.add("Nirmala");availableBooks.add("Rashmirathi");availableBooks.add("Pinjar");
        bookNumber.add("0201");bookNumber.add("0202");bookNumber.add("0203");bookNumber.add("0204");bookNumber.add("0205");
        bookNumber.add("0206");bookNumber.add("0207");bookNumber.add("0208");bookNumber.add("0209");bookNumber.add("0210");
        bookNumber.add("0211");
    }
    int userInput(){
    ...
    void issueBook(){
        Scanner scan=new Scanner(System.in);
        System.out.print("Enter the book number/name which to be issue ");
        ...
        bookNumber.remove(i);
        System.out.print("Name of person who issued the book ");
        scan.nextLine();
